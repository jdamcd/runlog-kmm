...
actual fun String.format(p1: Int, p2: Int): String = NSString.stringWithFormat(this, p1, p2)

actual fun String.format(p1: Int, p2: Int, p3: Int): String = NSString.stringWithFormat(this, p1, p2, p3)

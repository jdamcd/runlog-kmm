...
actual fun String.format(p1: Int, p2: Int, p3: Int): String = String.format(this, p1, p2, p3)

actual fun Float.formatDecimal(pattern: String): String = DecimalFormat(pattern).format(this)

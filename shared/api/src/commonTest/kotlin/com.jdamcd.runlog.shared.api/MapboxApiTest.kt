...
class MapboxApiTest {
    ...
    fun generatesMapUrlWithUrlEncodedPolyline() {
        val mapUrl = MapboxApi.staticMap(
            pathPolyline = polyline,
            accessToken = "mytoken"
        )

        mapUrl shouldBe "https://api.mapbox.com/styles/v1/mapbox/light-v10/static/path($encodedPolyline)/auto/400x160@2x?access_token=mytoken"
    }
    ...
    fun generatesMapUrlWithRequestedSize() {
        ...
        mapUrl shouldBe "https://api.mapbox.com/styles/v1/mapbox/light-v10/static/path($encodedPolyline)/auto/200x100@2x?access_token=mytoken"
    }
}
